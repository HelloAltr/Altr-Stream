...
class EditLogicalModelDialog extends StatefulWidget {
  final ApiClient apiClient;
  final LogicalModelModel model;
  final ValueChanged<LogicalModelModel> onModelUpdated;

  const EditLogicalModelDialog({
    super.key,
  ...
  @override
  State<EditLogicalModelDialog> createState() => _EditLogicalModelDialogState();
}

class _EditLogicalModelDialogState extends State<EditLogicalModelDialog> {
