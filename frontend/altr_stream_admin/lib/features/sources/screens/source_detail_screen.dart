          ...
          builder: (context, constraints) {
            ...
            final titleSection = Column(
              ...
              children: [
                ...
                Text(
                  widget.source.type == 'SQLITE'
                      ? 'File: ${widget.source.filePath ?? "Local Database"}'
                      : '${widget.source.host ?? "localhost"}:${widget.source.port ?? 5432} • Database: ${widget.source.databaseName ?? ""}',
                  style: TextStyle(
                    fontSize: 13,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.source.type == 'SQLITE') ...[
                    _buildInfoRow(context, 'Database Engine', 'SQLite (File Database)'),
                    _buildDivider(context),
                    _buildInfoRow(context, 'Database File Path', widget.source.filePath ?? '', isMonospace: true),
                  ] else ...[
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  if (widget.source.type == 'SQLITE') ...[
                    _buildInfoRow(context, 'Database Engine', 'SQLite', isMonospace: true),
                    _buildDivider(context),
                    _buildInfoRow(context, 'Database File Path', widget.source.filePath ?? '', isMonospace: true),
                    _buildDivider(context),
                    _buildInfoRow(context, 'Storage Mode', 'Local / Embedded File', isMonospace: true),
                    _buildDivider(context),
                    ...
                    _buildDivider(context),
                    _buildInfoRow(context, 'Listening Port', (widget.source.port ?? 5432).toString(), isMonospace: true),
                    _buildDivider(context),
                    _buildInfoRow(context, 'Database Name', widget.source.databaseName ?? '', isMonospace: true),
                    _buildDivider(context),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoRow(
                    context,
                    'Connection Protocol',
                    widget.source.type == 'SQLITE' ? 'Direct File I/O / aiosqlite driver' : 'Direct TCP Socket / PostgreSQL wire',
                  ),
                ],
              ),
            ),
