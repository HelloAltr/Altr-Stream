...
class AppConfig {
  ...
  static const String defaultAppVersion = '0.13.2-alpha';
  ...
  /// 3. Canonical default fallback [defaultAppVersion] (`0.13.1-alpha`).
  ...
  /// Returns the formatted version string prefixed with 'v' if needed (e.g. `v0.13.1-alpha`).
